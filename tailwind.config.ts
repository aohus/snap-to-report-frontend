...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ["Inter Variable", "Inter", "Pretendard Variable", "Pretendard", "system-ui", "sans-serif"],
      ...
      fontSize: {
        ...
        'lg': ['1rem', { lineHeight: '1.5rem', letterSpacing: '-0.015em' }],
        'xl': ['1.125rem', { lineHeight: '1.75rem', letterSpacing: '-0.02em' }],
        '2xl': ['1.25rem', { lineHeight: '1.75rem', letterSpacing: '-0.025em' }],
        '3xl': ['1.5rem', { lineHeight: '2rem', letterSpacing: '-0.03em' }],
      },
      boxShadow: {
        'subtle': '0 1px 2px 0 rgb(0 0 0 / 0.05)',
        'professional': '0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)',
        'emphasis': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)',
